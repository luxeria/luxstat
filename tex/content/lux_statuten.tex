...
\addtolength{\headwidth}{1cm}   % anpassen der
                                % Kopf/Fusszeilenbreite
                                % (Summe von den Oberen)

\fancyhead[L]{Lu\textbf{X}eria - Open Source, Open Mind}   
% Kopfzeile links
\fancyhead[C]{}            % Kopfzeile mitte
\fancyhead[R]{Statuten}    % Kopfzeile rechts

\renewcommand{\headrulewidth}{0.4pt} % obere Trennlinie

\fancyfoot[L]{Ervin M., Michael Z.} % Fusszeile links
...
\includepdf{lux_brief_statuten.pdf}
