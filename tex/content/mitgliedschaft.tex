...
\subsection{Referenz}
\subsubsection*{Artikel §\articlenumber}
\change{add}{Mitglieder können ihre Mitgliedschaft
referenzieren sofern dies nicht den Statuten widerspricht oder den
Vereinszwecken abträglich ist.}

\change{add}{Die Referenz der Mitgliedschaft ist insbesondere
in Zusammenhang mit politisch oder konfessionell motivierten Interessen zu
unterlassen, da diese die Neutralität des Vereins beeinträchtigen.}

\change{add}{Der Vorstand behält sich vor über Referenzen zu entscheiden.}
